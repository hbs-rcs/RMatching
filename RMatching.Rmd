...
(and a vast majority of control units) on strata that did not have any comparables from the other groups. (Note that we could've specified `discard = "both"` in `matchit()` to remove units that fall outside of some measure of support before matching). 
